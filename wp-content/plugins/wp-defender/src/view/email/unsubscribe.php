...
<p style="font-family: inherit; font-size: 16px; margin: 0 0 30px">
	<?php printf(
			__( 'You are now unsubscribed from %s. If you made a mistake and wish to continue receiving these emails, you can <a style="text-decoration: none;" href="%s">resubscribe</a>.', 'wpdef' ),
