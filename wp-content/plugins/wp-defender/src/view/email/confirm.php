...
<p style="font-family: inherit; font-size: 16px; margin: 0 0 30px">
	<?php printf(
			__( 'An administrator from <strong>%s</strong> has subscribed <strong>%s</strong> to <strong>%s</strong>. To confirm your subscription, click Confirm Subscription below.', 'wpdef' ),
			esc_url( $site_url ),
			esc_html( $email ),
