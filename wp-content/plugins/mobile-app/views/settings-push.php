...
<div class="cas--settings cas-settings--wide canvas-block">
	...
	<div class="cas--settings__content">
		...
		$bb_press_options = array(
			'bb_comment_reply' => array(
				'h4'    => 'All comment and reply',
				'p'     => 'Send notifications to subscribed users whenever a comment or reply is made',
				'label' => 'Enable notifications for comment or reply',
			),
		);
...
<div class="cas--settings cas-settings--wide canvas-block">
	...
	<div class="cas--settings__content">
		...
		<div class="cas--settings__layout-row">
			...
			<div class="cas--settings__layout-row-item">
				<input name="canvas_push_include_image" type="checkbox" id="canvas_push_include_image" value="1"<?php checked( Canvas::get_option( 'push_include_image', true ) ); ?>>
