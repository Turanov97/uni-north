...
class NextendSocialLogin {
    ...
    public static $nslPROMinVersion = '3.1.8';
    ...
    private static function getRenderedLoginButtons($labelType = 'login') {
        ...
        $ret = '<a href="'.wp_lostpassword_url().'" style="margin-left: 5px;">Forgot your password?</a>';
        /*$ret = '<a href="'.esc_url( wp_lostpassword_url() ).'" alt="'.esc_attr_e( 'Lost Password', 'textdomain' ).'">
                    '.esc_html_e( 'For Password', 'textdomain' ).'
                </a>';*/
