...
use RebelCode\Spotlight\Instagram\Performance\Analytics\RestApi\SetAnalyticsSettingsEndPoint;
            ...
            'tables/posts' => new Factory(
                ...
                function (string $prefix, Atlas $atlas) {
                    return $atlas->table($prefix . 'post_analytics', new Schema(
                        ...
                        [
                            // Keys
                            'sli_account_analytics_pk' => new Schema\PrimaryKey(['date', 'account', 'post']),
                        ]
                    ));
                }
            ),
