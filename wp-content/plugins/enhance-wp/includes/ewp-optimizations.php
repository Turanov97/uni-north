...
if($ewp_wp_rocket_support === "yes")
{
	
	//Exclude EWP Scripts from Rocket Delay JS
	function ewp_js_delay_exclusions ( $list )
	{
		array_push($list, 'mLQFAVgBhg', 'cz8MjVA6ko');
		return $list;
	}
	add_filter('rocket_delay_js_exclusions', 'ewp_js_delay_exclusions');
	
	
	//Remove Rocket Delay JS Scripts
	function ewp_remove_rocket_delayjs()
	{
...
<script src="data:text/javascript;base64," id="mLQFAVgBhg"></script>
	...
	add_action( 'wp_print_footer_scripts', 'ewp_fire_delayjs', 0 );
