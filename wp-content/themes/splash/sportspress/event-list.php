    ...
    <div class="sp-template sp-template-event-list">
        ...
        <div class="sp-table-wrapper">
            ...
            if ($scrollable) { ?> sp-scrollable-table<?php } ?>" data-sp-rows="<?php echo esc_attr($rows); ?>">
                ...
                <tr>
                    <?php
                    echo '<th class="data-date">' . esc_html__('Time', 'splash') . '</th>';
                ...
                foreach ($data as $event):
                    ...
                    echo '<td class="data-date" itemprop="startDate" content="' . mysql2date('Y-m-d\TH:iP', $event->post_date) . '" data-label="' . __('Date', 'splash') . '"> ' . mysql2date('g:ia', $event->post_date) . ' </td>';
                    ...
                    switch ($title_format) {
                        case 'homeaway':
                            ...
                            if ('combined' == $time_format && sp_column_active($usecolumns, 'time')) {
                                ...
                                if ($link_events) echo '<a href="' . get_post_permalink($event->ID, false, true) . '">';
                                if (!empty($main_results)):
                                    if ($main_results[0] > $main_results[1]) {
                                        echo '<img src="https://uni-norths.clubland.au/wp-content/uploads/2023/05/winn.png"/>';
                                    } else {
                                        echo '<img src="https://uni-norths.clubland.au/wp-content/uploads/2023/05/loss.png"/>';
                                    }
                                    echo implode(' - ', $main_results);
                                    if ($main_results[0] > $main_results[1]) {
                                        echo '<img src="https://uni-norths.clubland.au/wp-content/uploads/2023/05/loss.png"/>';
