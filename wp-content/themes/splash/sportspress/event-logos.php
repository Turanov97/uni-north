	...
	<?php if(!splash_is_layout("sccr")): ?>
	    ...
	    if (count($teams) > 1): ?>
	        ...
	        <div class="stm-next-match-unit">
	            ...
	            <div class="stm-next-match-main-meta test 2">
										...
										<div class="stm-command-results">
											<span>
                                                ...
                                                if(splash_is_layout('esport')){
                                                    ...
                                                    $team_1_label = '';
                                                    $team_2_label = '';
                                                    if(!empty($team_results[0][$team_1_id]['bp']) || $team_results[0][$team_1_id]['bp'] === '0'){
                                                        $team_1_score = $team_results[0][$team_1_id]['bp'];
                                                    }
                                                    if(!empty($team_results[0][$team_2_id]['bp']) || $team_results[0][$team_2_id]['bp'] === '0'){
                                                        $team_2_score = $team_results[0][$team_2_id]['bp'];
                                                    }
                                                ...
                                                <?php }
                                                    ...
                                                    if(!empty($team_results[0][$team_1_id]['bp']) || $team_results['0'][$team_1_id]['bp'] === '0'){
                                                        echo esc_html($team_results[0][$team_1_id]['bp']);
                                                    }
                                                    else echo '-';
                                                    ?> : <?php
                                                    if(!empty($team_results[0][$team_2_id]['bp']) || $team_results[0][$team_2_id]['bp'] === '0'){
                                                        echo esc_html($team_results[0][$team_2_id]['bp']);
                                                    }
                                                    else echo '-';
                                                }
